    ...
    private function normalizePropertyConfig(array $backendConfig)
    {
        foreach ($backendConfig['entities'] as $entityName => $entityConfig) {
            ...
            foreach (array('export') as $view) {
                ...
                $fields = array();
                if ($entityConfig[$view] == NULL || $entityConfig[$view]['fields'] == NULL) {
                    $entityConfig[$view]['fields'] = $backendConfig['entities'][$entityName]['list']['fields'];
                }
                ...
                foreach ($entityConfig[$view]['fields'] as $i => $field) {
                    ...
                    if (is_string($field)) {
                        ...
                        // Config format #2: field is an array that defines one or more
